...
st.caption("統計データの背景にある「一人ひとりの物語」を可視化する")
...
{
"role": "system",
"content": "あなたは熟練の政策アドバイザーです。ユーザーが選択した属性に基づき、統計データの背景にある300文字程度の切実な物語を生成してください。"
},
{
"role": "user",
...
st.write(story_text)
st.divider()
st.info("💡 参照：東京都 労働力統計（令和6年平均）、中野区 暮らしの状況調査")
st.markdown("参照：")
